...
const Dashboard: React.FC = () => {
  ...
  //     .trim();
  //   var white = getComputedStyle(document.body)
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xl-7 col-lg-8">
                  ...
                  <div className="mb-3 text-gray-500">
                    <i className="fa fa-caret-up"></i> 33.21% compare to last
                    week
                  </div>
              ...
              <div className="card border-0 text-truncate mb-3 bg-gray-800 text-white">
                <div className="card-body">
                  ...
                  <div className="mb-4 text-gray-500 ">
                    <i className="fa fa-caret-down"></i> 0.50% compare to last
                    week
                  </div>
                  <div className="d-flex mb-2">
                    ...
                    <div className="d-flex align-items-center ms-auto">
                      <div className="text-gray-500 small">
                        <i className="fa fa-caret-up"></i> 262%
                      </div>
